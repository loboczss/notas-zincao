...
const statusInfo = computed(() => {
  ...
  if (dias !== null && dias < 15) {
    return {
      label: 'Comprar',
      badge: 'bg-rose-50 text-rose-700 border border-rose-100 dark:bg-rose-950/30 dark:text-rose-450 dark:border-rose-900/40',
  ...
  if (dias !== null && dias < 45) {
    return {
      label: 'Atenção',
      badge: 'bg-amber-50 text-amber-700 border border-amber-100 dark:bg-amber-950/30 dark:text-amber-450 dark:border-amber-900/40',
  ...
  return {
    label: 'Saudável',
    badge: 'bg-emerald-50 text-emerald-700 border border-emerald-100 dark:bg-emerald-950/30 dark:text-emerald-450 dark:border-emerald-900/40',
    dot: 'bg-emerald-500',
