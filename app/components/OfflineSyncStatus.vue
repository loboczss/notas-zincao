...
<template>
  <div
    ...
    class="fixed bottom-4 left-4 z-50 flex max-w-[calc(100vw-2rem)] items-center gap-2 rounded-lg border px-3 py-2 text-xs shadow-lg backdrop-blur-md"
    :class="[
      isOnline
  ...
  >
    ...
    <span v-if="pendingCount > 0" class="rounded bg-black/10 px-1.5 py-0.5 dark:bg-white/10">
      {{ pendingCount }}
    </span>
